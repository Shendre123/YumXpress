...
public class SellerRegestrationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(160, 106, 173));
    ...
    private void btnSellerRegesterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSellerRegesterActionPerformed
        ...
        try{
           CompanyPojo comp=new CompanyPojo(CompanyDAO.getNewId(),companyName.getText().trim(),ownerName.getText().trim(),PassEncryption.getEncryptedPass(String.valueOf(password.getPassword()).trim()),emailId.getText().trim(),securityKey.getText().trim()); 
    ...
    private boolean validateInputs(){
        if(companyName.getText().trim().isEmpty()||String.valueOf(password.getPassword()).trim().isEmpty()||ownerName.getText().trim().isEmpty()||emailId.getText().trim().isEmpty()||securityKey.getText().trim().isEmpty()){
            return false;
        }
        return true;
    }
