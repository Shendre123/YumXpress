...
public class Mailer {
    ...
    public static void sendMail(StaffPojo staff) throws MessagingException {
        final String username = "yumxpress111@gmail.com";
        final String password = "ampm jjrh bzns gnba";
    ...
    public static void sendMailToCustomer(CustomerPojo customer) throws MessagingException {
        ...
        String emailSubject = "Welcome to YummXpress - Your Ultimate Food Ordering Companion!";
        ...
        String emailBody = "Dear " + customer.getCustomerName() + ",\n"
                ...
                + "\n"
                + "Thank you for choosing YummXpress. We look forward to serving you delicious meals and making your food ordering experience truly memorable.\n"
                + "Happy Hunger!!\n"
                + "Best regards,\n"
                + "\n"
                + "YumXpress!";
